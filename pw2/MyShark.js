...
class MyShark extends THREE.Object3D {
    ...
    createMergedBodyGeometry(tailWidth, bodyWidth, headWidth) {
        ...
        const lowerBottomfinIndices = [0,2,1, 2,3,4, 0,2,3, 1,2,4];
        const midBottomfinIndices = [0,1,2, 2,4,3, 0,2,3, 1,4,2];
        const upperTopfinIndices = [0,2,1, 2,3,1, 4,5,2, 2,5,3, 0,2,6, 4,6,2, 1,3,7, 5,7,3];
        const upperBottomfinIndices = [0,2,1, 2,3,4, 0,3,2, 1,4,2];
